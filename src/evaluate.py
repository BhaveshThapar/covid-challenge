...
Flags:
  ...
  --print-results      Print per-scan results to log (for copy-paste to notes).
"""
import os
import sys
import argparse
...
def main():
    ...
    # ---- Print per-scan results to log (for copy-paste) ----
    if args.print_results:
        ...
        print("\n" + "=" * 60)
        print("PER-SCAN RESULTS (copy below into notes/Excel)")
        print("=" * 60)
